...
//As duas implementam a interface Runnable (é uma boa prática de O.O.) ou extends a classe Thread do pacote java.lang (não é uma boa ideia pq nós só extendemos uma classe quando vamos especializa-la;
...
//Métodos de garantia de prioridade Sleep(), Yield() e Join();
